...
/**
 * A class for compiling DOM list objects that don't have constructors.
 * 
 ...
 * 
 * @exports module:@lumjs/web-core/listcompiler
 */
class ListCompiler
{
  /**
   ...
   * 
   * @param {Document} [doc=document] Document to use as top-most parent 
   */
   ...
   * @returns {module:@lumjs/web-core/listcompiler~ListBuilder}
   */
  buildList(proto)
  {
   ...
   * 
   * Adds a prototype for `TouchList` to `this.protos` the first
  ...
  buildTouchList()
  {
    if (!this.protos.TouchList)
    {
      ...
      const touchEvent = new window.TouchEvent(TEV);
  ...
  makeNodeList(...nodes)
  {
    ...
    for (const node of nodes)
    {
      ...
      else if (U.isCollection(node, Node))
 ...
 * 
 * @property {module:@lumjs/web-core/listcompiler} compiler - The parent compiler.
 ...
 * 
 * @alias module:@lumjs/web-core/listcompiler~ListBuilder
 */
class ListBuilder
{
  /**
  * Build a ListBuilder instance.
  * @param {module:@lumjs/web-core/listcompiler} compiler - The parent compiler.
  ...
  * @callback module:@lumjs/web-core/listcompiler~PlaceHolderSetMethod
  ...
  */
   ...
   * @typedef {object} module:@lumjs/web-core/listcompiler~PlaceHolderObject
   * @property {number} index - The position in the list we're building.
   * @property {*} value - Will be `null` until `set()` is called.
   * @property {module:@lumjs/web-core/listcompiler~PlaceHolderSetMethod} set 
   *   The `set()` method.
   ...
   * to determine the next positional index to use in the list.
   * 
   * @returns {module:@lumjs/web-core/listcompiler~PlaceHolderObject} 
   *   A placeholder object.
   */
  addPlaceholder()
  {
