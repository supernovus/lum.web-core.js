...
exports = module.exports =
{
   ...
   * @alias module:@lumjs/web-core.files
   * @see module:@lumjs/web-core/files
   */
  files: require('./files'),
  /**
...
/**
 * jQuery helpers (lazy-loaded)
 * @name module:@lumjs/web-core.jq
 * @see module:@lumjs/web-core/jq
 */
lazy(exports, 'jq', () => require('./jq'));
...
const shortcuts =
{
  ...
  download: exports.files.download,
